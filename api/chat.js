...
- **プロフィール**:ニックネーム・利き手・目標アベレージ/目標スコア(上限300)・ホームセンターを登録。マイボール/ハウスボールを登録名付きで複数登録可能(コアタイプ・カバーストック・球質・レーンコンディションも記録可)。マイシューズ/レンタルシューズも登録できる
- **フォーム分析**:投球フォームの動画をアップロードし、スロー再生(通常・0.75・0.5・0.25・0.1倍)や一時停止で確認できる。「この投球全体を解析する」でAIが投球全体(アプローチ〜フォロースルー)を見て、良い点・改善点をコメントする(フックボール・ストレート・ローダウン・サムレスなど、投げ方の違いも考慮する)
